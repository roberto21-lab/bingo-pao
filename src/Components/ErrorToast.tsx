...
export default function ErrorToast({ message, subMessage, onClose }: ErrorToastProps) {
  ...
  return (
    <Box
      sx={{
        ...
        border: "1px solid rgba(244, 67, 54, 0.3)", // Red border for error
        borderRadius: "12px",
        padding: 2,
        ...
        "&::before": {
          ...
          right: 0,
          bottom: 0,
          background: "linear-gradient(135deg, rgba(244, 67, 54, 0.1) 0%, rgba(244, 67, 54, 0.05) 100%)", // Red gradient
          pointerEvents: "none",
          zIndex: 0,
        },
      }}
